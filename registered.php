...
$sql="INSERT INTO bike_apply (fname,lname,phone,email,time) VALUES ('".$_POST["fname"]."','".$_POST["lname"]."','".$_POST["phone"]."','".$_POST["email"]."','".$time."');";
...
<html>
<head>
<title>Decimus Financial | Form</title>
<!-- for-mobile-apps -->
...
<!-- register -->
	<div class="register">
		<div class="container">
			<h2><font color="#009ee5">Register Here</font></h2>
