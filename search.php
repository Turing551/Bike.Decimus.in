...
<html>
<head>
<title>Decimus Financial | HARLEY DAVIDSON</title>
<!-- for-mobile-apps -->
...
$result = $conn->query($sql);
    ...
    while($row = $result->fetch_assoc()) {
    					...
    					if (strpos(strtolower($row["name"]), strtolower($ser)) !== false or strpos(strtolower($row["brand"]), strtolower($ser)) !== false) { 
								...
								echo'<a href="#">';
									...
									echo'<div class="mid-1">';
										...
										echo'<div class="mid-2">';
											echo'<p>'. $row["capacity"].'cc   '. $row["milage"].'kmpl    '. $row["bhp"].'bhp   '. $row["starttype"].'start</p>';
											echo'<p><font size="3px" color="black">On road price,Pune:</font></p><br><br>';
